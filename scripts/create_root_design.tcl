...
proc create_hier_cell_zynq_us_ss_0 { parentCell nameHier } {
  ...
  set xlconcat0 [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconcat:1.0 xlconcat0 ]
...
\
  ...
  connect_bd_intf_net -intf_net intf_net_axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins M00_AXI]
  connect_bd_intf_net -intf_net intf_net_axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins M01_AXI]
  connect_bd_intf_net -intf_net intf_net_axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins M02_AXI]
  ...
  connect_bd_intf_net -intf_net intf_net_axi_interconnect_0_M05_AXI [get_bd_intf_pins axi_interconnect_0/M05_AXI] [get_bd_intf_pins M05_AXI]
  connect_bd_intf_net -intf_net intf_net_axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_interconnect_0/M06_AXI] [get_bd_intf_pins M06_AXI]
  connect_bd_intf_net -intf_net intf_net_axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_interconnect_0/M08_AXI] [get_bd_intf_pins M08_AXI]
  connect_bd_intf_net -intf_net intf_net_fmch_axi_iic_IIC [get_bd_intf_pins fmch_axi_iic/IIC] [get_bd_intf_pins IIC]
  connect_bd_intf_net -intf_net intf_net_zynq_us_M_AXI_HPM0_LPD [get_bd_intf_pins zynq_us/M_AXI_HPM0_LPD] [get_bd_intf_pins axi_interconnect_0/S00_AXI]

  # Create port connections
  connect_bd_net -net net_bdry_in_ext_reset_in  [get_bd_pins ext_reset_in] \
  [get_bd_pins rst_processor_1_100M/ext_reset_in] \
  [get_bd_pins rst_processor_1_300M/ext_reset_in]
  connect_bd_net -net net_bdry_in_hdmi_rx_irq  [get_bd_pins hdmi_rx_irq] \
  [get_bd_pins xlconcat0/In1]
  connect_bd_net -net net_bdry_in_hdmi_tx_irq  [get_bd_pins hdmi_tx_irq] \
  [get_bd_pins xlconcat0/In2]
  connect_bd_net -net net_bdry_in_vphy_irq  [get_bd_pins vphy_irq] \
  [get_bd_pins xlconcat0/In0]
  connect_bd_net -net net_rst_processor_1_100M_peripheral_aresetn  [get_bd_pins rst_processor_1_100M/peripheral_aresetn] \
  [get_bd_pins fmch_axi_iic/s_axi_aresetn] \
  [get_bd_pins axi_interconnect_0/aresetn] \
  [get_bd_pins peripheral_aresetn]
  connect_bd_net -net net_rst_processor_1_300M_peripheral_aresetn  [get_bd_pins rst_processor_1_300M/peripheral_aresetn] \
  [get_bd_pins dcm_locked]
  connect_bd_net -net net_xlconcat0_dout  [get_bd_pins xlconcat0/dout] \
  [get_bd_pins zynq_us/pl_ps_irq0]
  connect_bd_net -net net_zynq_us_pl_clk0  [get_bd_pins zynq_us/pl_clk0] \
  [get_bd_pins rst_processor_1_100M/slowest_sync_clk] \
  [get_bd_pins zynq_us/maxihpm0_lpd_aclk] \
  [get_bd_pins fmch_axi_iic/s_axi_aclk] \
  [get_bd_pins s_axi_aclk] \
  [get_bd_pins axi_interconnect_0/aclk]
  connect_bd_net -net net_zynq_us_pl_clk1  [get_bd_pins zynq_us/pl_clk1] \
  [get_bd_pins rst_processor_1_300M/slowest_sync_clk] \
  [get_bd_pins axi_interconnect_0/aclk1] \
  [get_bd_pins clk_out2]
  connect_bd_net -net net_zynq_us_pl_resetn0  [get_bd_pins zynq_us/pl_resetn0] \
...
proc create_hier_cell_audio_ss_0 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net intf_net_axi_smartconnect_M02_AXI [get_bd_intf_pins axi_smartconnect/M02_AXI] [get_bd_intf_pins clk_wiz/s_axi_lite]
  ...
  [get_bd_pins clk_wiz/s_axi_aclk] \
  ...
  connect_bd_net -net net_bdry_in_hdmi_clk  [get_bd_pins hdmi_clk] \
  [get_bd_pins hdmi_acr_ctrl/hdmi_clk]
  connect_bd_net -net net_clk_wiz_clk_out1  [get_bd_pins clk_wiz/clk_out1] \
  [get_bd_pins audio_clk] \
  [get_bd_pins aud_pat_gen/axis_clk] \
  [get_bd_pins aud_pat_gen/aud_clk] \
  [get_bd_pins hdmi_acr_ctrl/aud_clk]
  connect_bd_net -net net_clk_wiz_locked  [get_bd_pins clk_wiz/locked] \
  ...
  connect_bd_net -net net_hdmi_acr_ctrl_aud_resetn_out  [get_bd_pins hdmi_acr_ctrl/aud_resetn_out] \
...
proc create_hier_cell_v_tpg_ss_0 { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net net_axi_gpio_gpio_io_o  [get_bd_pins axi_gpio/gpio_io_o] \
  [get_bd_pins v_tpg/ap_rst_n]
  connect_bd_net -net net_bdry_in_ap_clk  [get_bd_pins ap_clk] \
  [get_bd_pins axi_gpio/s_axi_aclk] \
  [get_bd_pins v_tpg/ap_clk]
  connect_bd_net -net net_bdry_in_m_axi_aresetn  [get_bd_pins m_axi_aresetn] \
...
proc create_root_design { parentCell } {
  ...
  set vcc_const0 [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconstant:1.0 vcc_const0 ]
  ...
  # Create instance: vdma_mem_ic, and set properties
  ...
  connect_bd_intf_net -intf_net intf_net_vid_phy_controller_vid_phy_rx_axi4s_ch1 [get_bd_intf_pins vid_phy_controller/vid_phy_rx_axi4s_ch1] [get_bd_intf_pins v_hdmi_rx_ss/LINK_DATA1_IN]
  connect_bd_intf_net -intf_net intf_net_vid_phy_controller_vid_phy_rx_axi4s_ch2 [get_bd_intf_pins vid_phy_controller/vid_phy_rx_axi4s_ch2] [get_bd_intf_pins v_hdmi_rx_ss/LINK_DATA2_IN]
  ...
  connect_bd_intf_net -intf_net intf_net_zynq_us_ss_0_IIC [get_bd_intf_pins zynq_us_ss_0/IIC] [get_bd_intf_ports fmch_iic]
  connect_bd_intf_net -intf_net intf_net_zynq_us_ss_0_M00_AXI [get_bd_intf_pins zynq_us_ss_0/M00_AXI] [get_bd_intf_pins vid_phy_controller/vid_phy_axi4lite]
  connect_bd_intf_net -intf_net intf_net_zynq_us_ss_0_M01_AXI [get_bd_intf_pins zynq_us_ss_0/M01_AXI] [get_bd_intf_pins v_hdmi_rx_ss/S_AXI_CPU_IN]
  connect_bd_intf_net -intf_net intf_net_zynq_us_ss_0_M02_AXI [get_bd_intf_pins zynq_us_ss_0/M02_AXI] [get_bd_intf_pins v_hdmi_tx_ss/S_AXI_CPU_IN]
  ...
  connect_bd_intf_net -intf_net tx_video_axis_reg_slice_M_AXIS [get_bd_intf_pins tx_video_axis_reg_slice/M_AXIS] [get_bd_intf_pins vdma_frame_buffer_top_0/HDMI_S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets tx_video_axis_reg_slice_M_AXIS] [get_bd_intf_pins tx_video_axis_reg_slice/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net vdma_frame_buffer_top_0_M_AXIS [get_bd_intf_pins vdma_frame_buffer_top_0/HDMI_M_AXIS] [get_bd_intf_pins v_hdmi_tx_ss/VIDEO_IN]
connect_bd_intf_net -intf_net [get_bd_intf_nets vdma_frame_buffer_top_0_M_AXIS] [get_bd_intf_pins vdma_frame_buffer_top_0/HDMI_M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets vdma_s2mm_stream] [get_bd_intf_pins vdma_frame_buffer_top_0/VDMA_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  [get_bd_pins v_hdmi_tx_ss/acr_n]
  connect_bd_net -net net_audio_ss_0_aud_acr_valid_out  [get_bd_pins audio_ss_0/aud_acr_valid_out] \
  [get_bd_pins v_hdmi_tx_ss/acr_valid]
  connect_bd_net -net net_audio_ss_0_aud_rstn  [get_bd_pins audio_ss_0/aud_rstn] \
  [get_bd_pins v_hdmi_tx_ss/s_axis_audio_aresetn] \
  [get_bd_pins v_hdmi_rx_ss/s_axis_audio_aresetn]
  connect_bd_net -net net_audio_ss_0_audio_clk  [get_bd_pins audio_ss_0/audio_clk] \
  [get_bd_pins v_hdmi_tx_ss/s_axis_audio_aclk] \
  [get_bd_pins v_hdmi_rx_ss/s_axis_audio_aclk]
  connect_bd_net -net net_bdry_in_HDMI_RX_CLK_N_IN  [get_bd_ports HDMI_RX_CLK_N_IN] \
  [get_bd_pins vid_phy_controller/mgtrefclk1_pad_n_in]
  connect_bd_net -net net_bdry_in_HDMI_RX_CLK_P_IN  [get_bd_ports HDMI_RX_CLK_P_IN] \
  [get_bd_pins vid_phy_controller/mgtrefclk1_pad_p_in]
  connect_bd_net -net net_bdry_in_HDMI_RX_DAT_N_IN  [get_bd_ports HDMI_RX_DAT_N_IN] \
  [get_bd_pins vid_phy_controller/phy_rxn_in]
  connect_bd_net -net net_bdry_in_HDMI_RX_DAT_P_IN  [get_bd_ports HDMI_RX_DAT_P_IN] \
  [get_bd_pins vid_phy_controller/phy_rxp_in]
  connect_bd_net -net net_bdry_in_RX_DET_IN  [get_bd_ports RX_DET_IN] \
  [get_bd_pins v_hdmi_rx_ss/cable_detect]
  connect_bd_net -net net_bdry_in_SI5324_LOL_IN  [get_bd_ports SI5324_LOL_IN] \
  [get_bd_pins vid_phy_controller/tx_refclk_rdy]
  connect_bd_net -net net_bdry_in_TX_HPD_IN  [get_bd_ports TX_HPD_IN] \
  [get_bd_pins v_hdmi_tx_ss/hpd]
  connect_bd_net -net net_bdry_in_TX_REFCLK_N_IN  [get_bd_ports TX_REFCLK_N_IN] \
  [get_bd_pins vid_phy_controller/mgtrefclk0_pad_n_in]
  ...
  [get_bd_pins dru_ibufds_gt_odiv2/BUFG_GT_I]
  connect_bd_net -net net_gt_refclk_buf_IBUF_OUT  [get_bd_pins gt_refclk_buf/IBUF_OUT] \
  [get_bd_pins vid_phy_controller/gtsouthrefclk0_in]
  connect_bd_net -net net_v_hdmi_rx_ss_acr_cts  [get_bd_pins v_hdmi_rx_ss/acr_cts] \
  [get_bd_pins audio_ss_0/aud_acr_cts_in]
  connect_bd_net -net net_v_hdmi_rx_ss_acr_n  [get_bd_pins v_hdmi_rx_ss/acr_n] \
  [get_bd_pins audio_ss_0/aud_acr_n_in]
  connect_bd_net -net net_v_hdmi_rx_ss_acr_valid  [get_bd_pins v_hdmi_rx_ss/acr_valid] \
  [get_bd_pins audio_ss_0/aud_acr_valid_in]
  connect_bd_net -net net_v_hdmi_rx_ss_fid  [get_bd_pins v_hdmi_rx_ss/fid] \
  [get_bd_pins v_hdmi_tx_ss/fid]
  connect_bd_net -net net_v_hdmi_rx_ss_hpd  [get_bd_pins v_hdmi_rx_ss/hpd] \
  [get_bd_ports RX_HPD_OUT]
  connect_bd_net -net net_v_hdmi_rx_ss_irq  [get_bd_pins v_hdmi_rx_ss/irq] \
  [get_bd_pins zynq_us_ss_0/hdmi_rx_irq]
  connect_bd_net -net net_v_hdmi_tx_ss_irq  [get_bd_pins v_hdmi_tx_ss/irq] \
  [get_bd_pins zynq_us_ss_0/hdmi_tx_irq]
  connect_bd_net -net net_v_hdmi_tx_ss_locked  [get_bd_pins v_hdmi_tx_ss/locked] \
  [get_bd_ports LED0]
  connect_bd_net -net net_vcc_const0_dout  [get_bd_pins vcc_const0/dout] \
  [get_bd_pins dru_ibufds_gt_odiv2/BUFG_GT_CE]
  connect_bd_net -net net_vcc_const_dout  [get_bd_pins vcc_const/dout] \
  [get_bd_ports TX_EN_OUT] \
  [get_bd_pins vid_phy_controller/vid_phy_tx_axi4s_aresetn] \
  [get_bd_pins vid_phy_controller/vid_phy_rx_axi4s_aresetn]
  connect_bd_net -net net_vid_phy_controller_irq  [get_bd_pins vid_phy_controller/irq] \
  [get_bd_pins zynq_us_ss_0/vphy_irq]
  connect_bd_net -net net_vid_phy_controller_phy_txn_out  [get_bd_pins vid_phy_controller/phy_txn_out] \
  [get_bd_ports HDMI_TX_DAT_N_OUT]
  connect_bd_net -net net_vid_phy_controller_phy_txp_out  [get_bd_pins vid_phy_controller/phy_txp_out] \
  [get_bd_ports HDMI_TX_DAT_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_n  [get_bd_pins vid_phy_controller/rx_tmds_clk_n] \
  [get_bd_ports RX_REFCLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_p  [get_bd_pins vid_phy_controller/rx_tmds_clk_p] \
  [get_bd_ports RX_REFCLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_video_clk  [get_bd_pins vid_phy_controller/rx_video_clk] \
  [get_bd_pins v_hdmi_rx_ss/video_clk]
  connect_bd_net -net net_vid_phy_controller_rxoutclk  [get_bd_pins vid_phy_controller/rxoutclk] \
  [get_bd_pins vid_phy_controller/vid_phy_rx_axi4s_aclk] \
  [get_bd_pins v_hdmi_rx_ss/link_clk]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk  [get_bd_pins vid_phy_controller/tx_tmds_clk] \
  [get_bd_pins audio_ss_0/hdmi_clk]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_n  [get_bd_pins vid_phy_controller/tx_tmds_clk_n] \
  [get_bd_ports HDMI_TX_CLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_p  [get_bd_pins vid_phy_controller/tx_tmds_clk_p] \
  [get_bd_ports HDMI_TX_CLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_video_clk  [get_bd_pins vid_phy_controller/tx_video_clk] \
  [get_bd_pins v_hdmi_tx_ss/video_clk]
  connect_bd_net -net net_vid_phy_controller_txoutclk  [get_bd_pins vid_phy_controller/txoutclk] \
  [get_bd_pins vid_phy_controller/vid_phy_tx_axi4s_aclk] \
  [get_bd_pins v_hdmi_tx_ss/link_clk]
  connect_bd_net -net net_zynq_us_ss_0_clk_out2  [get_bd_pins zynq_us_ss_0/clk_out2] \
  [get_bd_pins rx_video_axis_reg_slice/aclk] \
  [get_bd_pins v_tpg_ss_0/ap_clk] \
  ...
  assign_bd_address -offset 0x80060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_us_ss_0/zynq_us/Data] [get_bd_addr_segs v_tpg_ss_0/axi_gpio/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_us_ss_0/zynq_us/Data] [get_bd_addr_segs v_hdmi_rx_ss/S_AXI_CPU_IN/Reg] -force
