...
#
# Generated by Vivado on Mon Mar 16 16:55:49 CET 2026
...
# Scripts dir
set scripts_dir "$origin_dir/scripts"
...
set file "${origin_dir}/src/rtl/vdma_frame_buffer.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "used_in" -value "synthesis implementation" -objects $file_obj
set_property -name "used_in_simulation" -value "0" -objects $file_obj
...
set file "${origin_dir}/src/rtl/vdma_ctrl.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "used_in" -value "synthesis implementation" -objects $file_obj
set_property -name "used_in_simulation" -value "0" -objects $file_obj
...
add_files -norecurse -fileset $obj $xdc_list

# Add/Import constrs file and set constrs file properties
set file "$origin_dir/src/constraints/hdmi_example_zcu102.xdc"
set file [file normalize $file]
...
set_property -name "steps.phys_opt_design.tcl.post" -value "$scripts_dir/phys_opt_design.tcl" -objects $obj
set_property -name "steps.phys_opt_design.args.directive" -value "AggressiveFanoutOpt" -objects $obj
set_property -name "steps.route_design.tcl.post" -value "$scripts_dir/route_design.tcl" -objects $obj
...
set_property -name "steps.post_route_phys_opt_design.tcl.post" -value "$scripts_dir/postroute_phys_opt_design.tcl" -objects $obj
...
#*****************************************************************************************
# Call create_root_design (auto-gen by vivado) and generate wrapper
#*****************************************************************************************
